...
type Settings struct {
	...
	EnableAutoWebsocketTransformationPassthrough *bool                   `json:"enableAutoWebsocketTransformationPassthrough,omitempty" desc:"Set this option to enable auto websocket passthrough for the transformation filter. This will detect websocket request and do not buffer the body in the transformation filter"`
